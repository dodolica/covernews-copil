                    ...
                    <div class="col-sm-6 <?php echo esc_attr($layout_1); ?>">
                        ...
                        if ($all_posts->have_posts()) :
                            while ($all_posts->have_posts()) : $all_posts->the_post();
                                $covernews_thumbs_size = 'thumbnail';
                                if ($layout_1 == 'full-plus-list') {
                                    if ($count_1 == 1) {
                                        $covernews_thumbs_size = 'covernews-medium';
                                    }
                                }

                                if (has_post_thumbnail()) {
                                    $thumb = wp_get_attachment_image_src(get_post_thumbnail_id(get_the_ID()), $covernews_thumbs_size);
                                    $url = $thumb['0'];
